          ...
          <div class="box box-primary">
            ...
            <h3 class="profile-username text-center">{{$user->firstname . " " . $user->lastname}}</h3>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Telephone</b> <a class="pull-right">{{$user->phonenumber}}</a>
                </li>
                <li class="list-group-item">
                  <b>Birthdate</b> <a class="pull-right">{{$user->birth_date}}</a>
                </li>
                <li class="list-group-item">
              ...
              <a href='/user/users/{{ $user->id }}/edit' class="btn btn-primary btn-block"><b>Edit Profile</b></a>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <br>
                            <div class="col-md-12">
                                <a href="{{ route('change.userpassword') }}">Change Password</a>
                            </div>
                        </div>
                    </div>
                </div>
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="{{url('')}}/design/adminlte/dist/img/user6-128x128.jpg" alt="User Image">
                        <span class="username">
                          <a href="#">Adam Jones</a>
                  ...
                  <div class="row margin-bottom">
                    <div class="col-sm-6">
                      <img class="img-responsive" src="{{url('')}}/design/adminlte/dist/img/photo1.png" alt="Photo">
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          <img class="img-responsive" src="{{url('')}}/design/adminlte/dist/img/photo2.png" alt="Photo">
                          <br>
                          <img class="img-responsive" src="{{url('')}}/design/adminlte/dist/img/photo3.jpg" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <img class="img-responsive" src="{{url('')}}/design/adminlte/dist/img/photo4.jpg" alt="Photo">
                          <br>
                          <img class="img-responsive" src="{{url('')}}/design/adminlte/dist/img/photo1.png" alt="Photo">
                        </div>
                        <!-- /.col -->
